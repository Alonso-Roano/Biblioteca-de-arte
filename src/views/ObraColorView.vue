  ...
  <div class="containColor">
    <div class="colores">
      <div class="paper-sizes">
        <h2>Selecciona un Tamaño de Papel</h2>
      ...
      <div class="contenedorPadre">
        <div class="upload-area">
          <div class="upload-icon">
            <img src="https://static-00.iconduck.com/assets.00/upload-icon-2048x2048-eu9n5hco.png" alt="Upload Icon"
    ...
    <div class="imagenes">
      ...
      <div v-else class="img-origin">
        <img src="/image/imageColor.png" alt="Default Image 1" />
        <img src="/image/imageColor2.png" alt="Default Image 2" />
      </div>
    </div>
  </div>
</template>
