    ...
    >
      <div class="flex flex-col gap-4">
        <div>
          ...
          <InputText v-model="artist.id" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Nombre</label>
          <InputText v-model="artist.nombres" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Apellido</label>
          <InputText v-model="artist.apellidos" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Edad</label>
          <InputText v-model="artist.edad" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Application User</label>
          <InputText v-model="artist.idApplicationUser" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Fecha de creacion</label>
          <InputText v-model="artist.createdAt" class="w-full" disabled />
        </div>
