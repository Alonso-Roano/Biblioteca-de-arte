  ...
  >
    <div class="flex flex-col gap-4">
      ...
      <div>
        ...
        <InputText v-model="Obra.nombre" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Descripción de la Categoría</label>
        <InputText v-model="Obra.descripcionObra" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Nombre Corto</label>
        <InputText v-model="Obra.nombreCorto" class="w-full" disabled />
      </div>
      <div>
