  ...
  >
    <div class="flex flex-col gap-4">
      <div>
        ...
        <InputText v-model="Categoria.id" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Nombre</label>
        <InputText v-model="Categoria.nombre" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Descripción de la Categoría</label>
        <InputText v-model="Categoria.descripcionCategoria" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Nombre Corto</label>
        <InputText v-model="Categoria.nombreCorto" class="w-full" disabled />
      </div>
      <div>
        <label class="block text-gray-600">Fecha de Creación</label>
        <InputText v-model="Categoria.createdAt" class="w-full" disabled/>
      </div>
