    ...
    >
      <div class="flex flex-col gap-4">
        <div>
          ...
          <InputText v-model="LogError.id" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Recurso</label>
          <InputText v-model="LogError.source" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Mensaje</label>
          <InputText v-model="LogError.message" class="w-full" disabled />
        </div>
        <div>
          <label class="block text-gray-600">Seguimiento</label>
          <Textarea v-model="LogError.stackTrace" class="w-full" disabled style="height: 200px;"/>
        </div>
        <div>
          <label class="block text-gray-600">Fecha de creacion</label>
          <InputText v-model="LogError.createdAt" class="w-full" disabled />
        </div>
