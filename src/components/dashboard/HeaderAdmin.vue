      ...
      <div :class="{
        ...
        <ul
          class="flex flex-col font-medium p-2 md:p-0 mt-4 rounded-lg md:space-x-8 
              ...
              <a href="/dashboard/users" :class="getActiveClass('/perfil')"
                class="block px-4 py-2 text-md  rounded-sm">Usuarios</a>
            </li>
            
            <li class="block md:hidden">
              <a href="/dashboard/libros" :class="getActiveClass('/perfil')"
                class="block px-4 py-2 text-md  rounded-sm">Libros</a>
            </li>
            <li class="block md:hidden">
              <a href="/dashboard/etiquetas" :class="getActiveClass('/perfil')"
                class="block px-4 py-2 text-md  rounded-sm">Etiquetas</a>
            </li>
            <li class="block md:hidden">
              <a href="/dashboard/likes" :class="getActiveClass('/perfil')"
                class="block px-4 py-2 text-md  rounded-sm">Likes</a>
            </li>
          <!-- Menú de usuario si está autenticado -->
          <template v-if="isAuthenticated && isMobile">
            <li>
              <a href="/dashboard/perfil" :class="getActiveClass('/perfil')"
